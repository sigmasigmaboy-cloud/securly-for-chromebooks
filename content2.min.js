var port = chrome.runtime.connect({ name: "gmaps" }),
  ...
  observer = new MutationObserver(function (e) {
    e.some(function (e) {
      ...
      if (
        (t = (t = t.replace(/^\([0-9]{0,}\)\s/, "")).replace(/ +/g, " ")) !=
        prevTitle
      )
        return (prevTitle = t), fetchURL(), !0;
    });
  });
function sendData(e) {
  e != prevUrl &&
    ((prevUrl = document.location.href),
    port.postMessage({ action: "MapsURL", url: e }));
}
...
observer.observe(title, { subtree: !1, characterData: !0, childList: !0 });
