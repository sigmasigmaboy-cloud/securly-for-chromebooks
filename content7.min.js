!(function (e, t) {
      ...
      if (!i && (p(t), (t = t || d), g)) {
        ...
        if (
          ...
          if (((v = e), (m = t), 1 === w && (z.test(e) || G.test(e)))) {
            for (
              ((m = (ee.test(e) && ve(t.parentNode)) || t) === t && n.scope) ||
                ((c = t.getAttribute("id"))
                  ? (c = c.replace(re, ie))
  ...
  (b.filter = function (e, t, n) {
    ...
    b.fn.extend({
      ...
      is: function (e) {
        return !!k(this, "string" == typeof e && E.test(e) ? b(e) : e || [], !1)
          .length;
      },
    });
  var D,
    ...
    if (((n = n || D), "string" == typeof e)) {
      ...
      if (r[1]) {
        if (
          ...
          b.merge(
            this,
            b.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : y, !0),
          ),
          j.test(r[1]) && b.isPlainObject(t))
        )
          for (r in t) h(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
        return this;
      }
      return (
        (i = y.getElementById(r[2])) && ((this[0] = i), (this.length = 1)), this
      );
    }
    return e.nodeType
    ...
    b.extend({
      ...
      ready: function (e) {
        (!0 === e ? --b.readyWait : b.isReady) ||
          ((b.isReady = !0),
          (!0 !== e && --b.readyWait > 0) || B.resolveWith(y, [b]));
      },
    }),
    (b.ready.then = B.then),
    ...
    b.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = Y.get(o)), 1 === o.nodeType && !X.get(o, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
  ...
  function xe(e, t, n, r, i) {
    ...
    for (f.textContent = "", d = 0; (o = p[d++]); )
      if (r && b.inArray(o, r) > -1) i && i.push(o);
        ...
        ((l = re(o)), (a = ye(f.appendChild(o), "script")), l && ve(a), n)
      )
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (a.length)
                ...
                (r = n(this, t)),
                this[t](),
                a !== (o = X.get(this, t)) || r ? X.set(this, t, !1) : (o = {}),
                a !== o)
              )
                return (
  ...
  function He(e, t, n, r) {
    ...
    var i,
      ...
      y = t[0],
      v = h(y);
    if (v || (p > 1 && "string" == typeof y && !d.checkClone && je.test(y)))
    ...
    if (
      ...
      for (u = (s = b.map(ye(i, "script"), Ne)).length; f < p; f++)
        (l = i),
          f !== g &&
            ((l = b.clone(l, !0, !0)), u && b.merge(s, ye(l, "script"))),
          n.call(e[f], l, f);
      if (u)
          ...
          (l = s[f]),
            he.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : m(l.textContent.replace(ke, ""), l, c));
    }
    return e;
  }
  function Me(e, t, n) {
    for (var r, i = t ? b.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || b.cleanData(ye(r)),
        r.parentNode &&
          (n && re(r) && ve(ye(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  b.extend({
    ...
    b.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (b.cleanData(ye(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (b.cleanData(ye(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return He(
          ...
          function (t) {
            ...
            b.inArray(this, e) < 0 &&
              (b.cleanData(ye(this)), n && n.replaceChild(t, this));
          },
          e,
        );
      },
      ...
      function (e, t, n) {
        ...
        if ((u = !b.isEmptyObject(t)) || !b.isEmptyObject(d))
          for (r in (f &&
            ...
            null == (l = y && y.display) && (l = X.get(e, "display")),
        ...
        return "boolean" == typeof t && r
          ...
          : this.each(function () {
              ...
              if (r)
                ...
                (void 0 !== e && "boolean" !== n) ||
                  ((t = dt(this)) && X.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
  ...
  b.extend(b.event, {
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !p.noBubble && !g(r)) {
          for (
            u = p.delegateType || m, yt.test(u + m) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            v.push(a), (s = a);
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              ((s = r[l]) && (r[l] = null),
              (b.event.triggered = m),
              t.isPropagationStopped() && d.addEventListener(m, vt),
              r[m](),
              t.isPropagationStopped() && d.removeEventListener(m, vt),
            ...
            f
              ? (d.ifModified &&
                  ((C = S.getResponseHeader("Last-Modified")) &&
                    (b.lastModified[i] = C),
                  (C = S.getResponseHeader("etag")) && (b.etag[i] = C)),
                204 === t || "HEAD" === d.type
                  ? (T = "nocontent")
                  : 304 === t
                  ? (T = "notmodified")
                  : ((T = w.state), (p = w.data), (f = !(y = w.error))))
              : ((y = T), (!t && T) || ((T = "error"), t < 0 && (t = 0))),
            (S.status = t),
            (S.statusText = (n || T) + ""),
            f ? v.resolveWith(h, [p, T, S]) : v.rejectWith(h, [S, T, y]),
            S.statusCode(x),
            (x = void 0),
  ...
  b.ajaxSetup({
    ...
    (d.createHTMLDocument =
      (((Ft = y.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
...
var phrasesList,
  ...
  phraseMatchList = { Bully: [], Grief: [], Violence: [] },
  previousStr = "",
  mappingDictionary = {};
!(function (e) {
  function t() {
    featureConfig &&
      featureConfig.google_chat_flagging &&
      ((phrasesList = {
      ...
      (regexBullyArray = new RegExp(
        "\\b" + phrasesList.Bully.join("|"),
        "gim",
      )),
      (regexGriefArray = new RegExp(
        "\\b" + phrasesList.Grief.join("|"),
        "gim",
      )),
      (regexViolenceArray = new RegExp(
        "\\b" + phrasesList.Violence.join("|"),
        "gim",
      )),
      ...
      jqGCSecurly(document.body).on(
        ...
        function (e) {
          ...
          13 != r || e.shiftKey
            ? (previousStr = t)
            : (previousStr.length > 0 && n(previousStr, e), (previousStr = ""));
        },
      ),
      jqGCSecurly(document.body).on(
        "keydown",
        ...
        function (e) {
          ...
          t.length > 0 &&
            ...
            typedString.length > 0 &&
              setTimeout(function () {
                (0 != t[0].innerHTML.length && "<br>" != t[0].innerHTML) ||
                  n(typedString, e);
              }, 500));
        },
      ));
  ...
  function n(e, t) {
    let n = (e = e
        ...
        .replace(/<[^>]*>?/gm, "")
        .replace(/[\r\t\n]/gm, " ")
        .replace(/\s{2,}/g, " ")).replace(/[^a-zA-Z0-9 ]/g, ""),
      i = [...n.matchAll(regexBullyArray)];
    i.length > 0
      ? r(e, i, "Bully", t)
      : (i = [...n.matchAll(regexGriefArray)]).length > 0
      ? r(e, i, "Grief", t)
      : (i = [...n.matchAll(regexViolenceArray)]).length > 0 &&
        r(e, i, "Violence", t);
  }
  function r(e, t, n, r) {
    const i = [];
    let o = [];
    jqGCSecurly(r.currentTarget)
      .parents("body")
      .find("c-wiz[data-is-user-topic]")
      .each((e, t) => {
        var n = {
          userEmail: jqGCSecurly(t)
            .find("div[data-hovercard-id]")
            .data("hovercard-id"),
          displayname: jqGCSecurly(t).find("div[data-name]").data("name"),
          timestamp: jqGCSecurly(t)
            .find("span[data-absolute-timestamp]")
            .data("absolute-timestamp"),
          message: jqGCSecurly(t)
            .find("div[data-group-synthetic-id]")
            .parent()
            .parent()
            .parent()
            .text(),
        };
        (gChatId = jqGCSecurly(t)
          .find("div[data-group-synthetic-id]")
          .data("group-synthetic-id")),
          n.message.length > 0 && i.push(n);
      }),
      jqGCSecurly(r.currentTarget)
        .parents("body")
        .find('c-wiz[data-group-id="' + gChatId + '"]')
        .find("span[data-hovercard-id]")
        .each((e, t) => {
          var n = {
      ...
      (function (e, t, n, r, i) {
        let o = t
          .map((e) =>
            phraseMatchList[i].find((t) => t.Phrase.toLowerCase() == e),
          )
          .filter((e) => void 0 !== e);
        var a = {};
        (a.chatRoomId = gChatId),
          (a.flagged_text = e),
          (a.matched_phrase = t.join("|")),
          (a.context = r),
          (a.score = (function (e) {
            let t = 0,
              n = 0,
        ...
        (o = o.filter(
          (e, t, n) =>
            n.findIndex((t) =>
              ["displayname", "userEmail"].every((n) => t[n] === e[n]),
            ) === t,
        )),
        i,
        n,
