...
function interceptOrNot(e) {
  ...
  if (null !== localStorage.getItem(c))
    return window.featureConfig.isAwareOnly
      ? 0
      : (takeDenyActionTabs("G", "BL", "", window.btoa(s), e.tabId), (t = 0));
  ...
  return -1 != r.indexOf("twitter.com") &&
    (-1 != i.indexOf(window.twitterMessageURI) ||
      (-1 != i.indexOf("graphql") && -1 != i.indexOf("CreateTweet")) ||
...
function downloadPhraseMatch() {
  const e = createNonBlockingRequest(
    "get",
    "http://cdn1.securly.com/pmatch.json",
  );
  (e.onreadystatechange = function () {
    if (4 == e.readyState)
      if (200 == e.status)
        try {
          const t = CryptoJS.AES.decrypt(
            e.responseText,
...
function setupIWF() {
  ...
  isNaN(t)
    ? isNaN(t) &&
      0 === window.debugIWF &&
      (downloadIWFList(), downloadNonCIPA(), downloadPhraseMatch())
    : e - t >= window.IWFTimeout &&
      (downloadIWFList(), downloadNonCIPA(), downloadPhraseMatch());
}
...
function latencyCheck() {
  ...
  if (
    (null == e || Math.floor(Date.now() / 1e3) - e >= 86400) &&
    "unknown" != window.clusterUrl &&
    "AVOID_OS" != window.clusterUrl &&
    "UNKNOWN_SCHOOL" != window.clusterUrl
  ) {
...
function sendGoogleChatAnalytics(e) {
  if (
    ...
    const n = createNonBlockingRequest(
      "post",
      window.clusterUrl + "/gchat?userEmail=" + window.userEmail,
    );
    n.onreadystatechange = function () {
      4 == n.readyState &&
        200 != n.status &&
        console.log(
          "Error while sending chat to server from captured analytics",
          n.status,
        );
    };
    try {
...
function getSocialPost(e, t) {
  ...
  if (
    ...
    (-1 != e.url.indexOf(window.twitterMessageURI) ||
      (-1 != e.url.indexOf("graphql") && -1 != e.url.indexOf("CreateTweet"))) &&
    "POST" == e.method &&
              ...
              if (-1 == d.toLowerCase().indexOf("<html")) {
                ...
                if (0 == isNaN(c) && c >= 0) {
                  var h = Long.fromString(c, !0).shiftRight(0).toNumber(),
                    w = Long.fromNumber(Math.pow(2, 36))
                      .shiftRight(0)
                      .toNumber();
                  Long.fromNumber(h)
                    .and(Math.pow(2, 36))
  ...
  chrome.tabs.onUpdated.addListener(function (e, t, n) {
    ...
    chrome.runtime.onConnect.addListener(function (e) {
      "search_engine_parser" == e.name
        ...
        : "gchat-widget" == e.name &&
          e.onMessage.addListener(function (t, n) {
            "fetchInitialConfiguration" == t.action
              ? e.postMessage({
                  action: "initConfig",
                  phraseMatchList: phraseMatchList,
                  featureConfig: window.featureConfig,
                })
              : "sendGoogleChatAnaltics" == t.action &&
...
function onBeforeRequestListener(e, t = !1) {
  ...
  if (
    ...
    if (
      ("SS" == h &&
        (!1 !== (p = takeSafeSearchAction(c, o)) && (o = p), (v = !0)),
      "CC" == g &&
        (!1 !== (m = takeCreativeCommonImageSearchAction(o)) && (o = m),
        (v = !0)),
      ...
      var a = (i.MD5 = r.extend({
        ...
        _doProcessBlock: function (e, t) {
          ...
          (L = f(
            ...
            (N = f(
              N,
              (U = f(U, (B = f(B, L, N, U, g, 6, s[60])), L, N, _, 10, s[61])),
              B,
              L,
              h,
              15,
...
const wellPathWidgBg = (function () {
  var e = null,
    ...
    n = (n) => {
      ...
      chrome.cookies.getAll(
        { domain: o, name: "wellness_widget_status" },
        async (o) => {
                  ...
                  new Promise((n, o) => {
                    ...
                    try {
                      ...
                      if (
                        ...
                        (s.onerror = function () {
                          console.error(
                            "Error in fetching wellness pathways widget",
                          );
                        }),
                          (s.onload = function () {
                            r;
    ...
    chrome.runtime.onMessage.addListener((e, o) => {
      console.debug("wpw msg received", e, o),
        "object" == typeof e &&
          ...
          -1 != o.tab.id &&
          o.tab.id &&
          "well-path-widget" == e.source &&
          ("ready" == e.action && n(o.tab.id),
          ("ctaClicked" != e.action && "closed" != e.action) ||
            ((function (e) {
              try {
                ...
                "ctaClicked" == e.action &&
                  ((n.ctaLabel = e.label), (n.ctaLink = e.link));
                ...
                if (
                  ...
                  r.setRequestHeader("Content-Type", "application/json"),
                    ...
                    (r.onload = function () {
                      JSON.parse(r.responseText).success &&
...
window.featureConfig = {};
var phraseMatchList = { Bully: [], Grief: [], Violence: [] };
getVersion(),
  getGeolocationStatus(),
